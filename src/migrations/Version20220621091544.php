 ...
 */
final class Version20220621091544 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hotel ADD created_by_id INT DEFAULT NULL, ADD updated_by_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hotel DROP created_by_id, DROP updated_by_id');
